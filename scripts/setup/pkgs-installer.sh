...
declare -A PACKAGES=(
    ...
    ["DEVEL_PACKAGES"]="gtk+3-devel base-devel startup-notification-devel cairo-devel xcb-util-devel xcb-util-cursor-devel xcb-util-xrm-devel xcb-util-wm-devel"
